$(function () {
    ...
    $("#btnEditAddress").on('click', address.addEditAddress)
});
...
let address = {
  addEditAddress: function (option = false) {
      ...
      if (option) {
          document.getElementById("address").className = 'border border-success rounded';
          $("#btnEditAddress").show();
          $("#btnSaveAddress").hide();
      } else {
          document.getElementById("address").className = 'border border-danger rounded';
          $("#btnEditAddress").hide();
          $("#btnSaveAddress").show();
      }
  }
